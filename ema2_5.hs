...
moltiplicatore (x:[]) = 1
moltiplicatore (x:xs)
    | x < 0     = (moltiplicatore xs) / x
    | otherwise = (moltiplicatore xs) * x

-- Lista contente l'icroncio tra l'ema e i dati reali
risultante ampiezza lista = pulitore $ incrocia (drop (ampiezza - 1) lista) (ema ampiezza lista)
...
lordo ampiezza lista = moltiplicatore $ risultante ampiezza lista
